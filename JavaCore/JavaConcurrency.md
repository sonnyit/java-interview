...
1. [Explain usage of the couple wait()/notify()](#8-explain-usage-of-the-couple-waitnotify-)
1. [What does Volatile keyword mean?](#9-what-does-volatile-keyword-mean-)
1. [java.util.concurrent.* , what utils do you know?](#10-javautilconcurrent--what-utils-do-you-know-)
1. [ThreadLocal, what for are they needed? Does child thread see the value of parent ThreadLocal?](#11-threadlocal-what-for-are-they-needed-does-child-thread-see-the-value-of-parent-threadlocal-)
1. [Recommendations to avoid deadlocks.](#12-recommendations-to-avoid-deadlocks-)
1. [What is daemon thread and which method is used to create the daemon thread?](#13-what-is-daemon-thread-and-which-method-is-used-to-create-the-daemon-thread-)
1. [What method must be implemented by all threads?](#14-what-method-must-be-implemented-by-all-threads-)
1. [What is the difference between process and thread?](#15-what-is-the-difference-between-process-and-thread-)
1. What are the states associated in the thread?
1. [When you will synchronize a piece of your code?](#17-when-you-will-synchronize-a-piece-of-your-code-)
1. [What is deadlock? Example of deadlock.](#18-what-is-deadlock-example-of-deadlock-)
1. [Are there any global variables in Java, which can be accessed by other part of your program?](#19-are-there-any-global-variables-in-java-which-can-be-accessed-by-other-part-of-your-program-)
1. [What are Callable and FutureTask interfaces?](#20-what-are-callable-and-futuretask-interfaces-)
1. [What is Executors framework?](#21-what-is-executors-framework-)
1. [What is AtomicInteger](#22-what-is-atomicinteger-)
