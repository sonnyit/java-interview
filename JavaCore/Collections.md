...
### 9. What are the advantages of ArrayList over arrays ?
...
### 10. Principle of storing data in a hashtable
...
### 11. Differences between Hashtable, ConcurrentHashMap and Collections.synchronizedMap()
...
### 12. How are hash codes computed?
...
### 13. Is it possible that hash code is not unique?
...
### 14. Can we put two elements with equal hash code to one hash map?
...
### 15. Iterator and modification of a List. ConcurentModificationException.
...
### 16. What is the significance of ListIterator? What is the difference b/w Iterator and ListIterator?
...
### 20. Which implementation of the List interface provides for the fastest insertion of a new element into the middle of the list?
