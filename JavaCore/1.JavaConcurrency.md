...
1. [Why wait and notify method are called from synchronized block?]()
1. [What is the difference between notify and notifyAll in Java?]()
1. [Why wait, notify and notifyAll are not inside thread class?]()
...
1. [What is race condition in Java? Given one example?]()
