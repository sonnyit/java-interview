...
1. [How do you avoid deadlock in Java? Write Code?]()
...
1. [There are three threads T1, T2, and T3? How do you ensure sequence T1, T2, T3 in Java?]()
1. [What does yield method of Thread class do?]()
