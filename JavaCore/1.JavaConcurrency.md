...
1. [What is Thread in Java?](#https://github.com/sonnyit/java-interview/blob/master/JavaCore/1.JavaConcurrency.md#what-is-thread-in-java-)
...
1. [How to stop a thread in Java?](#https://github.com/sonnyit/java-interview/blob/master/JavaCore/1.JavaConcurrency.md#how-to-stop-a-thread-in-java-)
1. [What happens when an Exception occurs in a thread?](#https://github.com/sonnyit/java-interview/blob/master/JavaCore/1.JavaConcurrency.md#what-happens-when-an-exception-occurs-in-a-thread-)
1. [How do you share data between two thread in Java?](#https://github.com/sonnyit/java-interview/blob/master/JavaCore/1.JavaConcurrency.md#how-do-you-share-data-between-two-thread-in-java-)
...
1. [What is thread-safety? Is Vector a thread-safe class?](#)
...
1. ##### What is Thread in Java? [&#10548;](#java-concurrency)
  ...
  The thread is an independent path of execution. It's way to take advantage of multiple CPU available in a machine. By employing multiple threads you can speed up CPU bound task.
